...
class ProjectCheckboxSpinnerAdapter(
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        val view = convertView ?: inflater.inflate(R.layout.project_spinner_item, parent, false)
        val checkBox = view.findViewById<CheckBox>(R.id.checkboxProject)
        val textView = view.findViewById<TextView>(R.id.tvItemProject)
